  ...
  fluidPage(
    ...
    column(4,
      ...
      fluidRow(
        ...
        checkboxGroupInput("gGraphs", NULL, choices = c(
          "Discharge Capacity", "Discharge Areal Capacity",
          "Total Discharge Capacity", "Average Voltage", "Delta Voltage", "Capacity Loss"
        ), inline = FALSE),
